...
import { hasDriverPermission, isAuthenticated, logSecurityEvent } from '../../utils/security';
  ...
  function SecureComponent(props) {
    ...
    useEffect(() => {
      ...
      const checkAuth = async () => {
        ...
        if (authStatus && requireDriverApproval) {
          permissionStatus = await hasDriverPermission();
        }
        ...
        if (isMounted) {
          ...
          if (monitorActivity && authStatus) {
            logSecurityEvent('page_access', {
              ...
              requiresDriverApproval: requireDriverApproval,
              hasPermission: permissionStatus
            });
          }
        }
    ...
    if (requireDriverApproval && !auth.hasPermission) {
      return (
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700">
                  <p>
                    Your driver account is pending approval from our team. You will be notified once your account is approved.
                  </p>
                </div>
              </div>
            </div>
